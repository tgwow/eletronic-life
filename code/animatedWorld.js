...
(function() {
    ...
    function Animated(world) {
      ...
      this.button.style.cssText = "position: relative; bottom: -150px; right: 18.5em; color: white; font-family: tahoma, arial; " +
        "background: #000; cursor: pointer; border-radius: 18px; font-size: 70%; width: 3.5em; text-align: center;";
      ...
      active = this;
      this.interval = setInterval(function() { self.tick(); }, 110  );
    }
    ...
    Animated.prototype.clicked = function() {
      ...
      if (this.interval) {
        ...
        var self = this;
        this.interval = setInterval(function() { self.tick(); }, 222);
        this.button.innerHTML = "stop";
      }
    };
